...
ASSISTANT_DM_ALLOWED_MESSAGE_TYPES = frozenset({
    "ping",
    "pong",
    "request_state",
    "chat_message",
...
PLAYER_DENIED_MESSAGE_TYPES = frozenset({
    # Token/admin map control
    "token_create",
    "token_delete",
    "token_placed",
    "token_send_to_staging",
    "toggle_hidden",
    "token_hidden_changed",
    "bring_all_to_map",
    "local_map_enter",
    "local_map_exit",
    # Fog/map/editor writes
    "fog_paint",
    "fog_toggle",
    "editor_layer_save",
    "editor_layer_clear",
    ...
    "weather_set",
    "interactable_action",
    # DM/admin permission and content controls
    "grant_permission",
    ...
    "sound_set_ambient",
    "sound_stop_all",
    # DM-only AI/rest/conversation controls
    "ai_npc_speak",
    "ai_describe_scene",
    "camp_rest_start",
    "camp_rest_end",
...
PLAYER_ALLOWED_MESSAGE_TYPES = frozenset({
    "ping",
    "pong",
    "request_state",
    "chat_message",
