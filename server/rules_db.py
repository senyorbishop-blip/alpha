...
_SRD_MAGIC_ITEMS: List[Dict[str, Any]] = [
    ...
    {"id": "mi_vicious_rapier",       "name": "Vicious Rapier",  "rarity": "rare",      "item_type": "weapon", "attunement_required": 0, "description": "Weapon (rapier), rare. A magically cruel rapier that punishes perfect strikes.", "effect": "Rapier. Damage: 1d8 piercing. Properties: Finesse, Vex. When you roll a 20 on an attack roll with this magic weapon, the target takes an extra 7 piercing damage.", "unidentified_description": "A narrow blade with a hungry shimmer along its edge."},
    ...
    {"id": "mi_apparatus_kwalish",         "name": "Apparatus of Kwalish",          "rarity": "legendary", "item_type": "wondrous", "attunement_required": 0, "description": "A sealed crab-like vehicle with levers and claws.", "effect": "A complex apparatus that can move, swim, and make claw attacks while protecting occupants.", "unidentified_description": "A heavy barrel-shaped contraption with hidden seams and levers."},
    {"id": "mi_cloak_invisibility",        "name": "Cloak of Invisibility",        "rarity": "legendary", "item_type": "wondrous", "attunement_required": 1, "description": "A cloak that can turn its wearer unseen.", "effect": "Pull up the hood to become invisible for limited daily duration. Requires attunement.", "unidentified_description": "A soft cloak whose fabric fades at the edges."},
    {"id": "mi_ioun_greater_absorption",   "name": "Ioun Stone of Greater Absorption", "rarity": "legendary", "item_type": "wondrous", "attunement_required": 1, "description": "A violet-and-lavender stone that orbits its bearer.", "effect": "Can absorb high-level spells until its capacity is used. Requires attunement.", "unidentified_description": "A tiny polished stone that drifts upward when released."},
    {"id": "mi_ioun_mastery",              "name": "Ioun Stone of Mastery",        "rarity": "legendary", "item_type": "wondrous", "attunement_required": 1, "description": "A pale green prism that sharpens practiced skill.", "effect": "Increases proficiency bonus while orbiting you. Requires attunement.", "unidentified_description": "A pale green prism that hums beside your hand."},
    {"id": "mi_luck_blade_wish",           "name": "Luck Blade with Wishes",       "rarity": "legendary", "item_type": "weapon", "attunement_required": 1, "description": "A luck-blessed blade that may still hold wishes.", "effect": "+1 weapon. Grants luck rerolls and may contain 1d4-1 Wish charges. Requires attunement.", "unidentified_description": "A blade with a jewel that catches impossible reflections."},
    {"id": "mi_sphere_annihilation",       "name": "Sphere of Annihilation",       "rarity": "legendary", "item_type": "wondrous", "attunement_required": 0, "description": "A floating black void of destructive force.", "effect": "A controllable sphere that obliterates matter it passes through; mishaps can be catastrophic.", "unidentified_description": "A perfectly black floating orb that swallows nearby light."},
    {"id": "mi_talisman_pure_good",        "name": "Talisman of Pure Good",        "rarity": "legendary", "item_type": "wondrous", "attunement_required": 1, "description": "A holy talisman that harms the wicked.", "effect": "Charges can open a fissure beneath evil creatures. Requires attunement by a good-aligned divine bearer.", "unidentified_description": "A radiant symbol that feels warm to the righteous."},
    {"id": "mi_talisman_ultimate_evil",    "name": "Talisman of Ultimate Evil",    "rarity": "legendary", "item_type": "wondrous", "attunement_required": 1, "description": "An unholy talisman that punishes the virtuous.", "effect": "Charges can open a fissure beneath good creatures. Requires attunement by an evil divine bearer.", "unidentified_description": "A profane symbol cold enough to numb skin."},
    {"id": "mi_tome_stilled_tongue",       "name": "Tome of the Stilled Tongue",   "rarity": "legendary", "item_type": "wondrous", "attunement_required": 1, "description": "A forbidden spellbook bound with a still tongue.", "effect": "Contains spells and can enable rapid spellcasting at a cost. Requires attunement by a wizard.", "unidentified_description": "A locked book whose cover shifts like a mouth refusing to speak."},
