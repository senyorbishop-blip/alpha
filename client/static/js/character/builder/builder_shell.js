(function initCharacterBuilderShell(global) {
  ...
  function ensureShellStyles() {
    ...
    style.textContent = [
      ...
      '.character-builder-shell .cb-library-toolbar { display:grid; grid-template-columns:minmax(0,1fr) 130px; gap:6px; margin:6px 0; }',
      '.character-builder-shell .cb-library-selected { display:flex; flex-wrap:wrap; gap:5px; margin:6px 0; min-height:24px; align-items:center; }',
      '.character-builder-shell .cb-library-chip { display:inline-flex; align-items:center; gap:5px; border:1px solid rgba(201,168,76,0.3); border-radius:999px; padding:3px 7px; background:rgba(201,168,76,0.1); color:#E8C97A; font-size:0.68rem; }',
      '.character-builder-shell .cb-library-chip button { border:0; background:transparent; color:#E8C97A; cursor:pointer; font-size:0.82rem; line-height:1; padding:0 1px; }',
      '.character-builder-shell .cb-library-list { display:grid; grid-template-columns:repeat(auto-fit,minmax(170px,1fr)); gap:6px; max-height:240px; overflow:auto; padding-right:2px; }',
      '.character-builder-shell .cb-library-card { text-align:left; border:1px solid rgba(42,51,64,0.9); border-radius:9px; background:rgba(6,8,10,0.55); color:#e8e0d0; padding:7px 8px; display:flex; flex-direction:column; gap:3px; cursor:pointer; }',
      '.character-builder-shell .cb-library-card:hover:not(:disabled) { border-color:rgba(201,168,76,0.55); background:rgba(201,168,76,0.08); }',
      '.character-builder-shell .cb-library-card:disabled { opacity:0.55; cursor:default; }',
      '.character-builder-shell .cb-library-card strong { font-size:0.74rem; color:#f1e7cf; }',
      '.character-builder-shell .cb-library-card span { font-size:0.62rem; color:rgba(168,159,142,0.95); }',
      '.character-builder-shell .cb-library-card em { font-style:normal; font-size:0.61rem; color:rgba(168,159,142,0.72); line-height:1.3; max-height:2.6em; overflow:hidden; }',
      '.character-builder-shell .cb-library-card small { margin-top:2px; color:#C9A84C; font-size:0.58rem; text-transform:uppercase; letter-spacing:0.06em; }',
      '@media (max-width: 560px) { .character-builder-shell .cb-library-toolbar { grid-template-columns:1fr; } .character-builder-shell .cb-library-list { grid-template-columns:1fr; max-height:300px; } }',
